...
BLOG_AUTHOR = "rolando mosquera"  # (translatable)
BLOG_TITLE = "Rolando Mosquera"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://rolandomosquera.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://rolandomosquera.github.io/"
BLOG_EMAIL = "mosquera.rolando@gmail.com"
BLOG_DESCRIPTION = "Mon site personel"  # (translatable)
